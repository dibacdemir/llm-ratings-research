...
**Machine-readable findings:** [`../reports/2026-08-19_data_audit_findings.csv`](../reports/2026-08-19_data_audit_findings.csv) — 389 findings
...
3. **Missing or made-up dimension (~45 datasets high/medium).** 53 instructions are the
   ...
   texts recorded per dataset in `../reports/2026-08-19_data_audit_findings.csv`. For the rest the export genuinely
...
4. Adopt the ~23 dimension-specific instruction rewrites already drafted (in
   `../reports/2026-08-19_data_audit_findings.csv` `proposed_fix` column) where Title/Description grounds them.
...
`../reports/2026-08-19_data_audit.md` §2).** Do not use them until repaired.
...
`../reports/2026-08-19_data_audit.md`.
